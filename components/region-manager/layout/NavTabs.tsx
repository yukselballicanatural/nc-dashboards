...
export function NavTabs() {
  ...
  return (
    <nav aria-label={t("Bölge Müdürü paneli menüsü", "Region Manager panel menu")} className="-mx-1 overflow-x-auto py-1.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          return (
            <li key={item.href} className="shrink-0">
              ...
              >
                ...
                <span className="hidden sm:inline">{t(item.labelTr, item.labelEn)}</span>
              </Link>
            </li>
          );
        })}
