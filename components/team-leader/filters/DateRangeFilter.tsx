...
import { useTeamDateRange, type RangeKey } from "./TeamDateRangeContext";
...
const PRESETS: Array<{ key: Exclude<RangeKey, "custom">; label: string; labelEn: string }> = [
  { key: "today", label: "Bugün", labelEn: "Today" },
  { key: "7d", label: "7 Gün", labelEn: "7 Days" },
  { key: "30d", label: "30 Gün", labelEn: "30 Days" },
  { key: "90d", label: "90 Gün", labelEn: "90 Days" },
];
...
const QUICK_SHORTCUTS = [
  { label: "Son 14 gün", labelEn: "Last 14 days", days: 14 },
  { label: "Son 60 gün", labelEn: "Last 60 days", days: 60 },
  { label: "Bu yıl (YTD)", labelEn: "This year (YTD)", days: -1 }, // özel işaret: yıl başından bugüne
];
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-display text-[13.5px] font-semibold text-fg">
                    <T tr="Özel Tarih Aralığı" en="Custom Date Range" />
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {QUICK_SHORTCUTS.map((shortcut) => (
                    ...
                    >
                      {t(shortcut.label, shortcut.labelEn)}
                    </button>
                  ))}
                </div>
                ...
                >
                  <Check size={14} />
                  <T tr="Aralığı Uygula" en="Apply Range" />
                </button>
              </div>
            </motion.div>
          </>
